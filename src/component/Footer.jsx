    ...
    const fetchFooterData = async () => {
      try {
        const [
          ...
          supabase.from('home_content').select('logo_url').eq('identifier', 'home_main').single(),
          supabase.from('services').select('title').order('created_at', { ascending: true }).limit(6)
        ]);
    ...
    <footer className="site-footer">
      ...
      <div className="footer-main">
        ...
        <div className="footer-column brand-column">
          <Link href="/#home" className="footer-brand-link" onClick={(e) => handleSmoothScroll(e, 'home')}>
            <Image 
        ...
        <div className="footer-column">
          ...
          <ul className="footer-links">
            <li><Link href="/#home" onClick={(e) => handleSmoothScroll(e, 'home')}>Home</Link></li>
            <li><Link href="/#about" onClick={(e) => handleSmoothScroll(e, 'about')}>About Us</Link></li>
            <li><Link href="/#services" onClick={(e) => handleSmoothScroll(e, 'services')}>Our Services</Link></li>
            <li><Link href="/#packages" onClick={(e) => handleSmoothScroll(e, 'packages')}>Curated Packages</Link></li>
            <li><Link href="/#portfolio" onClick={(e) => handleSmoothScroll(e, 'portfolio')}>Portfolio Gallery</Link></li>
            <li><Link href="/#testimonials" onClick={(e) => handleSmoothScroll(e, 'testimonials')}>Client Stories</Link></li>
            <li><Link href="/#contact" onClick={(e) => handleSmoothScroll(e, 'contact')}>Contact & Concierge</Link></li>
          </ul>
        </div>
